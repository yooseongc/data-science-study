...
def plot_cities(cities: List[LabeledPoint]):
...
"""
 Plot k-NN Programming Languages
...
"""
 Print k-NN Predicted Languages
...
dimensions = range(1, 101, 5)  # 1, 6, 11, ... , 96
avg_distances = []
min_distances = []
for dim in dimensions:
    distances = random_distances(dim, 5)  # 10,000 random pairs
